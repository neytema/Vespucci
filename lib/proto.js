...
function Vespucci(content, map) {
    ...
    util.define(this, 'length', 0);
    util.define(this, 'content', content || '');
    util.define(this, 'points', []);
    util.define(this, '$$lines', []);
    ...
    if (this.mappings) {
        this.addPoints(mappings.parse(this.mappings));
    }
}
...
Vespucci.prototype.apply = function (content, map) { map; throw 'Not implemented'; };
